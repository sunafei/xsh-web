    ...
    <el-dialog title="密码验证"  :visible.sync="dialogPwdVisible">
      <el-form ref="checkForm" label-position="left" @submit.native.prevent>
        <el-form-item prop="pwd" style="text-align: center;">
          <el-input placeholder="请输入二级密码" v-model="pwd" show-password autofocus="true" autocomplete="off" @keyup.enter.native="checkPwdData('checkForm')">
...
<script>
  import { getList, saveOrUpdate, del } from '@/api/password'
