  ...
  <div class="login-container">
    ...
    <el-form class="login-form" autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left">
      ...
      <div style="position:relative;margin-top: -40px;">
        ...
        <div class="tips">
          <span style="margin-right:20px;">guest-username: guest</span><br />
          <span> guest-password: &nbsp;guest</span>
        </div>
        <githubAuth></githubAuth>
      </div>
    </el-form>
    <div style="position: absolute;bottom: 5px;width:100%;text-align: center;">
      <a href="http://www.beian.miit.gov.cn" target="_blank" style="color: #ffffff;">京ICP备20014887号</a>
    </div>
  </div>
</template>
<script>
